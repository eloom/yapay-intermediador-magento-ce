 ...
 */
class Eloom_Yapay_Enum_Properties_Current {
	 ...
	 */
	const ADDRESS_NUMBER = 'addressNumber';

	/**
	 * Addres complement for credit card direct payment
	 */
	const ADDRESS_COMPLEMENT = 'addressComplement';

	/**
	 * Billing addres district for credit card direct payment
	 */
	const ADDRESS_DISTRICT = 'addressDistrict';

	/**
	 * Billing addres city for credit card direct payment
	 */
	const ADDRESS_CITY = 'addressCity';

	/**
	 * Billing addres state for credit card direct payment
	 */
	const ADDRESS_STATE = 'addressState';

	/**
	 * Billing addres country for credit card direct payment
	 */
	const ADDRESS_COUNTRY = 'addressCountry';
	 ...
	 */
	const AVAILABLE_PAYMENT_METHOD = "paymentMethod";
	 ...
	 * Item shipping cost
	 */
	const ITEM_SHIPPING_PRICE = "itemShippingCost%s";
	 ...
	 * Customer name
	 */
	const CUSTOMER_NAME = "senderName";

	/**
	 * Customer email
	 */
	const CUSTOMER_EMAIL = "senderEmail";
	 ...
	 *  Customer CPF
	 */
	const DOCUMENT_CPF = "senderCPF";

	/**
	 * Customer CNPJ
	 */
	const DOCUMENT_CNPJ = "senderCNPJ";
	 ...
	 * Shipping cost
	 */
	const SHIPPING_PRICE = "shippingCost";
