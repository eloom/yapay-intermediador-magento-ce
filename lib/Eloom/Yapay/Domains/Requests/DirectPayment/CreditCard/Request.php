 ...
 */
class Eloom_Yapay_Domains_Requests_DirectPayment_CreditCard_Request implements Eloom_Yapay_Domains_Requests_Requests {
	...
	use Eloom_Yapay_Domains_Requests_DirectPayment_CreditCard_Installment;
	use Eloom_Yapay_Domains_Requests_DirectPayment_CreditCard_Holder;
	...
	use Eloom_Yapay_Domains_Requests_Split;
